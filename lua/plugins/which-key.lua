return {
  ...
  config = function ()
    ...
    wk.add({
        ...
        { "<leader>e", "<cmd>e ~/.config/nvim<cr>", desc = "Editar configurações" },
        { "<leader>f", "<cmd>Telescope find_files<cr>", desc = "Encontrar arquivos" },
        { "<leader>b", "<cmd>Telescope buffers<cr>", desc = "Buscar arquivos" },
        ...
        { "<leader>n", "<cmd>NvimTreeOpen<cr>", desc = "Navegador de arquivos" },
